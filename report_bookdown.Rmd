...
# Neural Network Feature Embeddings Visualization 
...
![R-TSNE plot for 2000 samples of the petdata images.](plots/tsne-2000.png)
...
```{r rtsne 3d, echo=FALSE, include=FALSE}
htmltools::includeHTML("tsne_plot_hover-2.html")
```
