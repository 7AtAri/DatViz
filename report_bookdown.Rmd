...
The necessary code [[2]](#8_References) was adapted and can be found in the neural network files folder. It was too big to be integrated as a python code junk.
...
> <a id="1">[1]</a> International Steering Committee for Global Mapping. Malaysia. Jabatan Ukur dan Pemetaan. (2012). Districts, Malaysia, 2013. [Shapefile]. International Steering Committee for Global Mapping. Retrieved from <https://earthworks.stanford.edu/catalog/stanford-zd362bc5680>
