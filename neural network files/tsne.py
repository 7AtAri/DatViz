...
def visualize_tsne_images(tx, ty, images, labels, plot_size=2000, max_image_size=200):
...
def visualize_tsne(tsne, images, labels, plot_size=2000, max_image_size=200):
